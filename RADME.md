# Система управления онлайн-обучением и тестированием
...
#### Тестируем
В качестве тестирования предлагается запустить коллекцию Postman по пути `postman/ORM_Exam.postman_collection.json`
...
Только unit + интеграционные тесты, профиль test
```shell
mvn test -P test
```
...
### Результат тестов
![Результат](./docs/test_result.png)
...
```markdown
OrmExam/
├── postman   # Коллекция Postman для тестов API
├── src/
│   ├── main/
│   │   ├── java/orm_exam/
